...
},{"../package.json":102,"./Plugin":98,"./loggers":100,"./supportsUploadProgress":101,"@uppy/store-default":170,"@uppy/utils/lib/Translator":189,"@uppy/utils/lib/generateFileID":195,"@uppy/utils/lib/getFileNameAndExtension":200,"@uppy/utils/lib/getFileType":201,"@uppy/utils/lib/prettyBytes":212,"cuid":13,"lodash.throttle":46,"mime-match":48,"namespace-emitter":49}],100:[function(require,module,exports){
...
},{"./AddFiles":103,"./AddFilesPanel":104,"./FileCard":106,"./FileList":113,"./PickerPanelContent":115,"./PickerPanelTopBar":116,"@uppy/utils/lib/isTouchDevice":209,"classnames":9,"preact":53,"preact-css-transition-group":52}],106:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"../../../utils/truncateString":126,"@uppy/utils/lib/prettyBytes":212,"preact":53}],109:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"./getActiveOverlayEl":121,"@uppy/utils/lib//FOCUSABLE_ELEMENTS":188,"@uppy/utils/lib/toArray":216}],126:[function(require,module,exports){
/**
...
},{"../package.json":131,"@uppy/core":99,"@uppy/utils/lib/findDOMElement":194,"@uppy/utils/lib/toArray":216,"get-form-data":37}],131:[function(require,module,exports){
module.exports={
  "name": "@uppy/form",
...
},{"../package.json":151,"./AuthView":139,"./Browser":141,"./Loader":149,"@uppy/utils/lib/generateFileID":195,"@uppy/utils/lib/getFileType":201,"@uppy/utils/lib/isPreviewSupported":208,"preact":53}],151:[function(require,module,exports){
module.exports={
...
},{"@uppy/core":99,"@uppy/utils/lib/findDOMElement":194,"@uppy/utils/lib/toArray":216}],154:[function(require,module,exports){
function _assertThisInitialized(self) {
  if (self === void 0) {
    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  }
...
},{"@uppy/dashboard":118}],157:[function(require,module,exports){
function _extends() {
  _extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
...
},{"@uppy/dropbox":128,"@uppy/google-drive":133,"@uppy/instagram":137,"@uppy/transloadit":179,"@uppy/url":185,"@uppy/webcam":222}],158:[function(require,module,exports){
var Transloadit = require('@uppy/transloadit');
...
},{"./TransloaditResultsPlugin":155,"@uppy/transloadit":179}],159:[function(require,module,exports){
function _extends() {
  _extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
...
},{"@uppy/core":99}],160:[function(require,module,exports){
function _extends() {
  _extends = Object.assign || function (target) {
    for (var i = 1; i < arguments.length; i++) {
      var source = arguments[i];
...
},{"./AttachFileInputs":153,"./TransloaditFormResult":154,"./addDashboardPlugin":156,"./addProviders":157,"./addTransloaditPlugin":158,"@uppy/core":99,"@uppy/form":130,"@uppy/status-bar":168,"@uppy/utils/lib/findDOMElement":194}],162:[function(require,module,exports){
...
},{"./addTransloaditPlugin":158,"./createUppy":159,"@uppy/utils/lib/toArray":216}],165:[function(require,module,exports){
module.exports={
  "name": "@uppy/robodog",
...
},{"./StatusBarStates":167,"@uppy/utils/lib/prettyBytes":212,"@uppy/utils/lib/prettyETA":213,"classnames":9,"lodash.throttle":46,"preact":53}],167:[function(require,module,exports){
module.exports = {
  'STATE_ERROR': 'error',
  'STATE_WAITING': 'waiting',
  'STATE_PREPROCESSING': 'preprocessing',
...
},{"../package.json":174,"./image-orientations":172,"@uppy/core":99,"@uppy/utils/lib/dataURItoBlob":191,"@uppy/utils/lib/isObjectURL":207,"@uppy/utils/lib/isPreviewSupported":208,"exif-js":35}],174:[function(require,module,exports){
module.exports={
...
},{"./parseUrl":180,"component-emitter":11,"socket.io-client":58}],176:[function(require,module,exports){
/**
...
},{"../package.json":183,"@uppy/companion-client":95,"@uppy/core":99,"@uppy/utils/lib/emitSocketProgress":192,"@uppy/utils/lib/getSocketHost":203,"@uppy/utils/lib/limitPromises":210,"@uppy/utils/lib/settle":215,"tus-js-client":85}],183:[function(require,module,exports){
module.exports={
  "name": "@uppy/tus",
...
},{"./getFileNameAndExtension":200,"./mimeTypes":211}],202:[function(require,module,exports){
...
},{"preact":53}],218:[function(require,module,exports){
function _inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
},{"./RecordButton":220,"./SnapshotButton":221,"preact":53}],219:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"preact":53}],220:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"./CameraIcon":217,"preact":53}],222:[function(require,module,exports){
var _class, _temp;
...
},{"../package.json":224,"./CameraIcon":217,"./CameraScreen":218,"./PermissionsScreen":219,"./supportsMediaRecorder":223,"@uppy/core":99,"@uppy/utils/lib/Translator":189,"@uppy/utils/lib/canvasToBlob":190,"@uppy/utils/lib/getFileTypeExtension":202,"preact":53}],223:[function(require,module,exports){
